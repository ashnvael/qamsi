...
class ExperimentConfig(BaseExperimentConfig):
    ...
    STOCKS_LIST_FILENAME: str = field(default="spx_stocks_list.csv", metadata={"docs": "Stocks list"})

    INITIAL_FEATURES_FILENAME: str = field(default="initial_features_df.csv", metadata={"docs": "Initial preprocessed features"})

    DF_FILENAME: str = field(default="spx_data.csv", metadata={"docs": "Preprocessed data (after experiments)"})
